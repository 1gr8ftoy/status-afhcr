...
use BConway\WebsiteBundle\Entity\Job;
use BConway\WebsiteBundle\Form\JobType;
...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BConwayWebsiteBundle:Job')->findAll();

        return $this->render('BConwayWebsiteBundle:Job:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BConwayWebsiteBundle:Job')->find($id);
        ...
        return $this->render('BConwayWebsiteBundle:Job:show.html.twig', array(
            'entity'      => $entity,
